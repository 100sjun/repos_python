...
! config
!
  integer, parameter :: species_max = 11, species_electrons = 1, species_length = 6, reactions_max = 36, reactions_length = 22
...
!
  ...
  integer, parameter, private               :: bolsig_species_max = 1, bolsig_species_length = 2, bolsig_rates_max = 7 
...
!
  ...
  /"bolsig:N2->N2(A3,V0-4)","bolsig:N2->N2(A3,V5-9)","bolsig:N2->N2(A3,V10-)","bolsig:N2->N2(B3)     ","bolsig:N2->N2(A'1)    ",&
   "bolsig:N2->N2(C3)     ","bolsig:N2->N2^+       ","N2(A)+N2(A')=>N4^++E  ","N2(A')+N2(A')=>N4^++E ","N^++E+N2=>N+N2        ",&
   "N2^++E=>N+N           ","N3^++E=>N2+N          ","N4^++E=>N2+N2         ","N^++N+N2=>N2^++N2     ","N^++N2+N2=>N3^++N2    ",&
   "N2^++N=>N^++N2        ","N2^++N2(A)=>N3^++N    ","N2^++N2+N=>N3^++N2    ","N2^++N2+N2=>N4^++N2   ","N3^++N=>N2^++N2       ",&
   "N4^++N=>N^++N2+N2     ","N4^++N2=>N2^++N2+N2   ","N2(A)=>N2             ","N2(B)=>N2(A)          ","N2(A')=>N2            ",&
   "N2(C)=>N2(B)          ","N2(A)+N=>N2+N         ","N2(A)+N2=>N2+N2       ","N2(A)+N2(A)=>N2+N2(B) ","N2(A)+N2(A)=>N2+N2(C) ",&
   "N2(B)+N2=>N2+N2       ","N2(B)+N2=>N2(A)+N2    ","N2(A')+N2=>N2+N2(B)   ","N2(C)+N2=>N2+N2(A')   ","N+N+N2=>N2(A)+N2      ",&
   "N+N+N2=>N2(B)+N2      "/
...
300 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file <" &
    ...
    close(ifile_unit)
311 format(261x,11(1x,i9))
312 format(A2,1x,A22,1x,11(1x,A9))
313 format(i2,1x,A22,1x,11(1x,1pd9.2))
  endif
  return
...
100 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    do i = 1, species_max
      write(ifile_unit,"(36(i3))",err=200) int(mrtm(i,:))
    enddo
    lerror = .false.
200 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    write(ifile_unit,"(1x,A14,11(111x,i2.2))",err=300) "Time_s", ( i, i = 1, species_max )
    lerror = .false.
300 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
...
400 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    write(ifile_unit,"(1x,A12,36(111x,i2.2))",err=500) "Time_s", ( i, i = 1, reactions_max )
    lerror = .false.
500 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
  ...
  if( ( time - densav(0,1) ) >= rtol .or. lfirst ) then
    ...
    if( rtol > qtplaskin_rtol .or. lfirst ) then
      ...
      write(ifile_unit,"(1pe15.6,11(1pe13.4))") densav(0,2), densav(1:,2)
      close(ifile_unit)
      ...
      write(ifile_unit,"(37(1pe13.4))") densav(0,2), rrt_loc(:)
      close(ifile_unit)
      densav(:,1) = densav(:,2)
    endif
  endif
...
subroutine ZDPlasKin_reac_source_matrix(reac_rate_local,reac_source_local)
  ...
  reac_source_local(04,08) = - reac_rate_local(08) 
  reac_source_local(06,08) = - reac_rate_local(08) 
  reac_source_local(11,08) = + reac_rate_local(08) 
  reac_source_local(01,09) = + reac_rate_local(09) 
  reac_source_local(06,09) = - reac_rate_local(09) * 2.d0
  reac_source_local(11,09) = + reac_rate_local(09) 
  reac_source_local(01,10) = - reac_rate_local(10) 
  reac_source_local(02,10) = + reac_rate_local(10) 
  reac_source_local(08,10) = - reac_rate_local(10) 
  reac_source_local(01,11) = - reac_rate_local(11) 
  reac_source_local(02,11) = + reac_rate_local(11) * 2.d0
  reac_source_local(09,11) = - reac_rate_local(11) 
  reac_source_local(01,12) = - reac_rate_local(12) 
  reac_source_local(02,12) = + reac_rate_local(12) 
  reac_source_local(03,12) = + reac_rate_local(12) 
  reac_source_local(10,12) = - reac_rate_local(12) 
  reac_source_local(01,13) = - reac_rate_local(13) 
  reac_source_local(03,13) = + reac_rate_local(13) * 2.d0
  reac_source_local(11,13) = - reac_rate_local(13) 
  reac_source_local(02,14) = - reac_rate_local(14) 
  reac_source_local(08,14) = - reac_rate_local(14) 
  reac_source_local(09,14) = + reac_rate_local(14) 
  reac_source_local(03,15) = - reac_rate_local(15) 
  reac_source_local(08,15) = - reac_rate_local(15) 
  ...
  reac_source_local(08,16) = + reac_rate_local(16) 
  reac_source_local(09,16) = - reac_rate_local(16) 
  reac_source_local(02,17) = + reac_rate_local(17) 
  reac_source_local(04,17) = - reac_rate_local(17) 
  reac_source_local(09,17) = - reac_rate_local(17) 
  ...
  reac_source_local(09,19) = - reac_rate_local(19) 
  reac_source_local(11,19) = + reac_rate_local(19) 
  reac_source_local(02,20) = - reac_rate_local(20) 
  reac_source_local(03,20) = + reac_rate_local(20) 
  reac_source_local(09,20) = + reac_rate_local(20) 
  reac_source_local(10,20) = - reac_rate_local(20) 
  reac_source_local(02,21) = - reac_rate_local(21) 
  reac_source_local(03,21) = + reac_rate_local(21) * 2.d0
  reac_source_local(08,21) = + reac_rate_local(21) 
  reac_source_local(11,21) = - reac_rate_local(21) 
  reac_source_local(03,22) = + reac_rate_local(22) 
  reac_source_local(09,22) = + reac_rate_local(22) 
  reac_source_local(11,22) = - reac_rate_local(22) 
  reac_source_local(03,23) = + reac_rate_local(23) 
  reac_source_local(04,23) = - reac_rate_local(23) 
  reac_source_local(04,24) = + reac_rate_local(24) 
  reac_source_local(05,24) = - reac_rate_local(24) 
  reac_source_local(03,25) = + reac_rate_local(25) 
  reac_source_local(06,25) = - reac_rate_local(25) 
  reac_source_local(05,26) = + reac_rate_local(26) 
  reac_source_local(07,26) = - reac_rate_local(26) 
  reac_source_local(03,27) = + reac_rate_local(27) 
  reac_source_local(04,27) = - reac_rate_local(27) 
  reac_source_local(03,28) = + reac_rate_local(28) 
  reac_source_local(04,28) = - reac_rate_local(28) 
  reac_source_local(03,29) = + reac_rate_local(29) 
  reac_source_local(04,29) = - reac_rate_local(29) * 2.d0
  reac_source_local(05,29) = + reac_rate_local(29) 
  reac_source_local(03,30) = + reac_rate_local(30) 
  reac_source_local(04,30) = - reac_rate_local(30) * 2.d0
  reac_source_local(07,30) = + reac_rate_local(30) 
  reac_source_local(03,31) = + reac_rate_local(31) 
  reac_source_local(05,31) = - reac_rate_local(31) 
  reac_source_local(04,32) = + reac_rate_local(32) 
  reac_source_local(05,32) = - reac_rate_local(32) 
  reac_source_local(05,33) = + reac_rate_local(33) 
  reac_source_local(06,33) = - reac_rate_local(33) 
  reac_source_local(06,34) = + reac_rate_local(34) 
  reac_source_local(07,34) = - reac_rate_local(34) 
  reac_source_local(02,35) = - reac_rate_local(35) * 2.d0
  reac_source_local(04,35) = + reac_rate_local(35) 
  reac_source_local(02,36) = - reac_rate_local(36) * 2.d0
  reac_source_local(05,36) = + reac_rate_local(36) 
  return
...
subroutine ZDPlasKin_fex(neq,t,y,ydot)
  ...
  if( lgas_heating ) ZDPlasKin_cfg(1) = y(12)
  density(:) = y(1:species_max)
  call ZDPlasKin_reac_rates(t)
  rrt(01) = rrt(01) * density(01) * density(03) 
  rrt(02) = rrt(02) * density(01) * density(03) 
  rrt(03) = rrt(03) * density(01) * density(03) 
  rrt(04) = rrt(04) * density(01) * density(03) 
  rrt(05) = rrt(05) * density(01) * density(03) 
  rrt(06) = rrt(06) * density(01) * density(03) 
  rrt(07) = rrt(07) * density(01) * density(03) 
  rrt(08) = rrt(08) * density(04) * density(06) 
  rrt(09) = rrt(09) * density(06)**2 
  rrt(10) = rrt(10) * density(01) * density(03) * density(08) 
  rrt(11) = rrt(11) * density(01) * density(09) 
  rrt(12) = rrt(12) * density(01) * density(10) 
  rrt(13) = rrt(13) * density(01) * density(11) 
  rrt(14) = rrt(14) * density(02) * density(03) * density(08) 
  rrt(15) = rrt(15) * density(03)**2 * density(08) 
  rrt(16) = rrt(16) * density(02) * density(09) 
  rrt(17) = rrt(17) * density(04) * density(09) 
  rrt(18) = rrt(18) * density(02) * density(03) * density(09) 
  rrt(19) = rrt(19) * density(03)**2 * density(09) 
  rrt(20) = rrt(20) * density(02) * density(10) 
  rrt(21) = rrt(21) * density(02) * density(11) 
  rrt(22) = rrt(22) * density(03) * density(11) 
  rrt(23) = rrt(23) * density(04) 
  rrt(24) = rrt(24) * density(05) 
  rrt(25) = rrt(25) * density(06) 
  rrt(26) = rrt(26) * density(07) 
  rrt(27) = rrt(27) * density(02) * density(04) 
  rrt(28) = rrt(28) * density(03) * density(04) 
  rrt(29) = rrt(29) * density(04)**2 
  rrt(30) = rrt(30) * density(04)**2 
  rrt(31) = rrt(31) * density(03) * density(05) 
  rrt(32) = rrt(32) * density(03) * density(05) 
  rrt(33) = rrt(33) * density(03) * density(06) 
  rrt(34) = rrt(34) * density(03) * density(07) 
  rrt(35) = rrt(35) * density(02)**2 * density(03) 
  rrt(36) = rrt(36) * density(02)**2 * density(03) 
  ydot(01) = +rrt(07)+rrt(08)+rrt(09)-rrt(10)-rrt(11)-rrt(12)-rrt(13) 
  ydot(02) = +rrt(10)+ 2.d0 * rrt(11)+rrt(12)-rrt(14)-rrt(16)+rrt(17)-rrt(18)-rrt(20)-rrt(21)- 2.d0 * rrt(35)- 2.d0 * rrt(36) 
  ydot(03) = -rrt(01)-rrt(02)-rrt(03)-rrt(04)-rrt(05)-rrt(06)-rrt(07)+rrt(12)+ 2.d0 * rrt(13)-rrt(15)+rrt(16)-rrt(19)+rrt(20)&
             + 2.d0 * rrt(21)+rrt(22)+rrt(23)+rrt(25)+rrt(27)+rrt(28)+rrt(29)+rrt(30)+rrt(31) 
  ydot(04) = +rrt(01)+rrt(02)+rrt(03)-rrt(08)-rrt(17)-rrt(23)+rrt(24)-rrt(27)-rrt(28)- 2.d0 * rrt(29)- 2.d0 * rrt(30)+rrt(32)&
             +rrt(35) 
  ydot(05) = +rrt(04)-rrt(24)+rrt(26)+rrt(29)-rrt(31)-rrt(32)+rrt(33)+rrt(36) 
  ydot(06) = +rrt(05)-rrt(08)- 2.d0 * rrt(09)-rrt(25)-rrt(33)+rrt(34) 
  ydot(07) = +rrt(06)-rrt(26)+rrt(30)-rrt(34) 
  ydot(08) = -rrt(10)-rrt(14)-rrt(15)+rrt(16)+rrt(21) 
  ydot(09) = +rrt(07)-rrt(11)+rrt(14)-rrt(16)-rrt(17)-rrt(18)-rrt(19)+rrt(20)+rrt(22) 
  ydot(10) = -rrt(12)+rrt(15)+rrt(17)+rrt(18)-rrt(20) 
  ydot(11) = +rrt(08)+rrt(09)-rrt(13)+rrt(19)-rrt(21)-rrt(22) 
  if( ldensity_constant ) where( density_constant(:) ) ydot(1:species_max) = 0.0d0
  ydot(12) = 0.0d0
  if( lgas_heating ) then
    ydot(12) = ( ZDPlasKin_cfg(14)/k_B + ydot(12) ) / ( sum(density(1:species_max)) - density(species_electrons) ) &
            + eV_to_K * ZDPlasKin_cfg(11) * density(species_electrons)
    ydot(12) = ydot(12) * ZDPlasKin_cfg(13)
  endif
  return
...
subroutine ZDPlasKin_jex(neq,t,y,ml,mu,pd,nrpd)
  ...
  density(:) = y(1:species_max)
  call ZDPlasKin_reac_rates(t)
  pd(03,01) = pd(03,01) - rrt(01) * density(03) 
  pd(03,03) = pd(03,03) - rrt(01) * density(01) 
  pd(04,01) = pd(04,01) + rrt(01) * density(03) 
  pd(04,03) = pd(04,03) + rrt(01) * density(01) 
  pd(03,01) = pd(03,01) - rrt(02) * density(03) 
  pd(03,03) = pd(03,03) - rrt(02) * density(01) 
  pd(04,01) = pd(04,01) + rrt(02) * density(03) 
  pd(04,03) = pd(04,03) + rrt(02) * density(01) 
  pd(03,01) = pd(03,01) - rrt(03) * density(03) 
  pd(03,03) = pd(03,03) - rrt(03) * density(01) 
  pd(04,01) = pd(04,01) + rrt(03) * density(03) 
  pd(04,03) = pd(04,03) + rrt(03) * density(01) 
  pd(03,01) = pd(03,01) - rrt(04) * density(03) 
  pd(03,03) = pd(03,03) - rrt(04) * density(01) 
  pd(05,01) = pd(05,01) + rrt(04) * density(03) 
  pd(05,03) = pd(05,03) + rrt(04) * density(01) 
  pd(03,01) = pd(03,01) - rrt(05) * density(03) 
  pd(03,03) = pd(03,03) - rrt(05) * density(01) 
  pd(06,01) = pd(06,01) + rrt(05) * density(03) 
  pd(06,03) = pd(06,03) + rrt(05) * density(01) 
  pd(03,01) = pd(03,01) - rrt(06) * density(03) 
  pd(03,03) = pd(03,03) - rrt(06) * density(01) 
  pd(07,01) = pd(07,01) + rrt(06) * density(03) 
  pd(07,03) = pd(07,03) + rrt(06) * density(01) 
  pd(01,01) = pd(01,01) + rrt(07) * density(03) 
  pd(01,03) = pd(01,03) + rrt(07) * density(01) 
  pd(03,01) = pd(03,01) - rrt(07) * density(03) 
  pd(03,03) = pd(03,03) - rrt(07) * density(01) 
  pd(09,01) = pd(09,01) + rrt(07) * density(03) 
  pd(09,03) = pd(09,03) + rrt(07) * density(01) 
  pd(01,04) = pd(01,04) + rrt(08) * density(06) 
  pd(01,06) = pd(01,06) + rrt(08) * density(04) 
  pd(04,04) = pd(04,04) - rrt(08) * density(06) 
  pd(04,06) = pd(04,06) - rrt(08) * density(04) 
  pd(06,04) = pd(06,04) - rrt(08) * density(06) 
  pd(06,06) = pd(06,06) - rrt(08) * density(04) 
  pd(11,04) = pd(11,04) + rrt(08) * density(06) 
  pd(11,06) = pd(11,06) + rrt(08) * density(04) 
  pd(01,06) = pd(01,06) + rrt(09) * density(06) * 2.0d0
  pd(06,06) = pd(06,06) - rrt(09) * density(06) * 4.0d0
  pd(11,06) = pd(11,06) + rrt(09) * density(06) * 2.0d0
  pd(01,01) = pd(01,01) - rrt(10) * density(03) * density(08) 
  pd(01,03) = pd(01,03) - rrt(10) * density(01) * density(08) 
  pd(01,08) = pd(01,08) - rrt(10) * density(01) * density(03) 
  pd(02,01) = pd(02,01) + rrt(10) * density(03) * density(08) 
  pd(02,03) = pd(02,03) + rrt(10) * density(01) * density(08) 
  pd(02,08) = pd(02,08) + rrt(10) * density(01) * density(03) 
  pd(08,01) = pd(08,01) - rrt(10) * density(03) * density(08) 
  pd(08,03) = pd(08,03) - rrt(10) * density(01) * density(08) 
  pd(08,08) = pd(08,08) - rrt(10) * density(01) * density(03) 
  pd(01,01) = pd(01,01) - rrt(11) * density(09) 
  pd(01,09) = pd(01,09) - rrt(11) * density(01) 
  pd(02,01) = pd(02,01) + rrt(11) * density(09) * 2.0d0
  pd(02,09) = pd(02,09) + rrt(11) * density(01) * 2.0d0
  pd(09,01) = pd(09,01) - rrt(11) * density(09) 
  pd(09,09) = pd(09,09) - rrt(11) * density(01) 
  pd(01,01) = pd(01,01) - rrt(12) * density(10) 
  pd(01,10) = pd(01,10) - rrt(12) * density(01) 
  pd(02,01) = pd(02,01) + rrt(12) * density(10) 
  pd(02,10) = pd(02,10) + rrt(12) * density(01) 
  pd(03,01) = pd(03,01) + rrt(12) * density(10) 
  pd(03,10) = pd(03,10) + rrt(12) * density(01) 
  pd(10,01) = pd(10,01) - rrt(12) * density(10) 
  pd(10,10) = pd(10,10) - rrt(12) * density(01) 
  pd(01,01) = pd(01,01) - rrt(13) * density(11) 
  pd(01,11) = pd(01,11) - rrt(13) * density(01) 
  pd(03,01) = pd(03,01) + rrt(13) * density(11) * 2.0d0
  pd(03,11) = pd(03,11) + rrt(13) * density(01) * 2.0d0
  pd(11,01) = pd(11,01) - rrt(13) * density(11) 
  pd(11,11) = pd(11,11) - rrt(13) * density(01) 
  pd(02,02) = pd(02,02) - rrt(14) * density(03) * density(08) 
  pd(02,03) = pd(02,03) - rrt(14) * density(02) * density(08) 
  pd(02,08) = pd(02,08) - rrt(14) * density(02) * density(03) 
  pd(08,02) = pd(08,02) - rrt(14) * density(03) * density(08) 
  pd(08,03) = pd(08,03) - rrt(14) * density(02) * density(08) 
  pd(08,08) = pd(08,08) - rrt(14) * density(02) * density(03) 
  pd(09,02) = pd(09,02) + rrt(14) * density(03) * density(08) 
  pd(09,03) = pd(09,03) + rrt(14) * density(02) * density(08) 
  pd(09,08) = pd(09,08) + rrt(14) * density(02) * density(03) 
  pd(03,03) = pd(03,03) - rrt(15) * density(03) * density(08) * 2.0d0
  pd(03,08) = pd(03,08) - rrt(15) * density(03)**2 
  pd(08,03) = pd(08,03) - rrt(15) * density(03) * density(08) * 2.0d0
  pd(08,08) = pd(08,08) - rrt(15) * density(03)**2 
  pd(10,03) = pd(10,03) + rrt(15) * density(03) * density(08) * 2.0d0
  pd(10,08) = pd(10,08) + rrt(15) * density(03)**2 
  pd(02,02) = pd(02,02) - rrt(16) * density(09) 
  pd(02,09) = pd(02,09) - rrt(16) * density(02) 
  pd(03,02) = pd(03,02) + rrt(16) * density(09) 
  pd(03,09) = pd(03,09) + rrt(16) * density(02) 
  pd(08,02) = pd(08,02) + rrt(16) * density(09) 
  pd(08,09) = pd(08,09) + rrt(16) * density(02) 
  pd(09,02) = pd(09,02) - rrt(16) * density(09) 
  pd(09,09) = pd(09,09) - rrt(16) * density(02) 
  pd(02,04) = pd(02,04) + rrt(17) * density(09) 
  pd(02,09) = pd(02,09) + rrt(17) * density(04) 
  pd(04,04) = pd(04,04) - rrt(17) * density(09) 
  pd(04,09) = pd(04,09) - rrt(17) * density(04) 
  pd(09,04) = pd(09,04) - rrt(17) * density(09) 
  pd(09,09) = pd(09,09) - rrt(17) * density(04) 
  pd(10,04) = pd(10,04) + rrt(17) * density(09) 
  pd(10,09) = pd(10,09) + rrt(17) * density(04) 
  pd(02,02) = pd(02,02) - rrt(18) * density(03) * density(09) 
  pd(02,03) = pd(02,03) - rrt(18) * density(02) * density(09) 
  pd(02,09) = pd(02,09) - rrt(18) * density(02) * density(03) 
  pd(09,02) = pd(09,02) - rrt(18) * density(03) * density(09) 
  pd(09,03) = pd(09,03) - rrt(18) * density(02) * density(09) 
  pd(09,09) = pd(09,09) - rrt(18) * density(02) * density(03) 
  pd(10,02) = pd(10,02) + rrt(18) * density(03) * density(09) 
  pd(10,03) = pd(10,03) + rrt(18) * density(02) * density(09) 
  pd(10,09) = pd(10,09) + rrt(18) * density(02) * density(03) 
  pd(03,03) = pd(03,03) - rrt(19) * density(03) * density(09) * 2.0d0
  pd(03,09) = pd(03,09) - rrt(19) * density(03)**2 
  pd(09,03) = pd(09,03) - rrt(19) * density(03) * density(09) * 2.0d0
  pd(09,09) = pd(09,09) - rrt(19) * density(03)**2 
  pd(11,03) = pd(11,03) + rrt(19) * density(03) * density(09) * 2.0d0
  pd(11,09) = pd(11,09) + rrt(19) * density(03)**2 
  pd(02,02) = pd(02,02) - rrt(20) * density(10) 
  pd(02,10) = pd(02,10) - rrt(20) * density(02) 
  pd(03,02) = pd(03,02) + rrt(20) * density(10) 
  pd(03,10) = pd(03,10) + rrt(20) * density(02) 
  pd(09,02) = pd(09,02) + rrt(20) * density(10) 
  pd(09,10) = pd(09,10) + rrt(20) * density(02) 
  pd(10,02) = pd(10,02) - rrt(20) * density(10) 
  pd(10,10) = pd(10,10) - rrt(20) * density(02) 
  pd(02,02) = pd(02,02) - rrt(21) * density(11) 
  pd(02,11) = pd(02,11) - rrt(21) * density(02) 
  pd(03,02) = pd(03,02) + rrt(21) * density(11) * 2.0d0
  pd(03,11) = pd(03,11) + rrt(21) * density(02) * 2.0d0
  pd(08,02) = pd(08,02) + rrt(21) * density(11) 
  pd(08,11) = pd(08,11) + rrt(21) * density(02) 
  pd(11,02) = pd(11,02) - rrt(21) * density(11) 
  pd(11,11) = pd(11,11) - rrt(21) * density(02) 
  pd(03,03) = pd(03,03) + rrt(22) * density(11) 
  pd(03,11) = pd(03,11) + rrt(22) * density(03) 
  pd(09,03) = pd(09,03) + rrt(22) * density(11) 
  pd(09,11) = pd(09,11) + rrt(22) * density(03) 
  pd(11,03) = pd(11,03) - rrt(22) * density(11) 
  pd(11,11) = pd(11,11) - rrt(22) * density(03) 
  pd(03,04) = pd(03,04) + rrt(23) 
  pd(04,04) = pd(04,04) - rrt(23) 
  pd(04,05) = pd(04,05) + rrt(24) 
  pd(05,05) = pd(05,05) - rrt(24) 
  pd(03,06) = pd(03,06) + rrt(25) 
  pd(06,06) = pd(06,06) - rrt(25) 
  pd(05,07) = pd(05,07) + rrt(26) 
  pd(07,07) = pd(07,07) - rrt(26) 
  pd(03,02) = pd(03,02) + rrt(27) * density(04) 
  pd(03,04) = pd(03,04) + rrt(27) * density(02) 
  pd(04,02) = pd(04,02) - rrt(27) * density(04) 
  pd(04,04) = pd(04,04) - rrt(27) * density(02) 
  pd(03,03) = pd(03,03) + rrt(28) * density(04) 
  pd(03,04) = pd(03,04) + rrt(28) * density(03) 
  pd(04,03) = pd(04,03) - rrt(28) * density(04) 
  pd(04,04) = pd(04,04) - rrt(28) * density(03) 
  pd(03,04) = pd(03,04) + rrt(29) * density(04) * 2.0d0
  pd(04,04) = pd(04,04) - rrt(29) * density(04) * 4.0d0
  pd(05,04) = pd(05,04) + rrt(29) * density(04) * 2.0d0
  pd(03,04) = pd(03,04) + rrt(30) * density(04) * 2.0d0
  pd(04,04) = pd(04,04) - rrt(30) * density(04) * 4.0d0
  pd(07,04) = pd(07,04) + rrt(30) * density(04) * 2.0d0
  pd(03,03) = pd(03,03) + rrt(31) * density(05) 
  pd(03,05) = pd(03,05) + rrt(31) * density(03) 
  pd(05,03) = pd(05,03) - rrt(31) * density(05) 
  pd(05,05) = pd(05,05) - rrt(31) * density(03) 
  pd(04,03) = pd(04,03) + rrt(32) * density(05) 
  pd(04,05) = pd(04,05) + rrt(32) * density(03) 
  pd(05,03) = pd(05,03) - rrt(32) * density(05) 
  pd(05,05) = pd(05,05) - rrt(32) * density(03) 
  pd(05,03) = pd(05,03) + rrt(33) * density(06) 
  pd(05,06) = pd(05,06) + rrt(33) * density(03) 
  pd(06,03) = pd(06,03) - rrt(33) * density(06) 
  pd(06,06) = pd(06,06) - rrt(33) * density(03) 
  pd(06,03) = pd(06,03) + rrt(34) * density(07) 
  pd(06,07) = pd(06,07) + rrt(34) * density(03) 
  pd(07,03) = pd(07,03) - rrt(34) * density(07) 
  pd(07,07) = pd(07,07) - rrt(34) * density(03) 
  pd(02,02) = pd(02,02) - rrt(35) * density(02) * density(03) * 4.0d0
  pd(02,03) = pd(02,03) - rrt(35) * density(02)**2 * 2.0d0
  pd(04,02) = pd(04,02) + rrt(35) * density(02) * density(03) * 2.0d0
  pd(04,03) = pd(04,03) + rrt(35) * density(02)**2 
  pd(02,02) = pd(02,02) - rrt(36) * density(02) * density(03) * 4.0d0
  pd(02,03) = pd(02,03) - rrt(36) * density(02)**2 * 2.0d0
  pd(05,02) = pd(05,02) + rrt(36) * density(02) * density(03) * 2.0d0
  pd(05,03) = pd(05,03) + rrt(36) * density(02)**2 
  ...
  if( lgas_heating ) then
    pd(12,1) = eV_to_K * ZDPlasKin_cfg(11)
    pd(12,:) = pd(12,:) * ZDPlasKin_cfg(13)
  endif
  return
...
subroutine ZDPlasKin_reac_rates(Time)
  ...
  rrt(08) = 4.0D-12
  rrt(09) = 4.0D-11
  rrt(10) = 6.0D-27*(300./TE)**1.5
  rrt(11) = 1.8D-07*(300./TE)**0.39
  rrt(12) = 2.0D-07*(300./TE)**0.5
  rrt(13) = 2.3D-06*(300./TE)**0.53
  rrt(14) = 1.0D-29
  rrt(15) = 1.7D-29*(300./TEFF)**2.1
  rrt(16) = 7.2D-13*(TEFF/300.)
  rrt(17) = 3.0D-10
  rrt(18) = 9.0D-30*EXP(400./TEFF)
  rrt(19) = 5.2D-29*(300./TEFF)**2.2
  rrt(20) = 6.6D-11
  rrt(21) = 1.0D-11
  rrt(22) = 2.1D-16*EXP(TEFF/121.)
  rrt(23) = 5.0D-01
  rrt(24) = 1.3D+05
  rrt(25) = 1.0D+02
  rrt(26) = 2.5D+07
