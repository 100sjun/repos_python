...
class ParameterOptimizer:
    def __init__(self):
        ...
        self.n_trials = 1000 # number of optimization trials
        ...
        try:
            for v in Volt:
                ...
                for i, para_name in enumerate(para.keys()):
                    para[para_name] = np.exp(alpha[para_name]*(PD0-PD))
    ...
    def update_bounds_callback(self, study, trial):
        ...
        if study.best_trial.number == trial.number:
            ...
            self.update_bnds(list(study.best_params.values()))
