...
class ParameterOptimizer:
    def __init__(self):
        ...
        self.db_path = 'detailed_results15.db'  # 별도의 상세 결과 저장용 DB
        self.optuna_db_path = 'optuna_study15.db'  # Optuna 전용 DB
        self.setup_database()
